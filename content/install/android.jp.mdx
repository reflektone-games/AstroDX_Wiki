...
もし失敗したら、 AstroDXのルートフォルダ(`Android/data/com.Reflektone.AstroDX/files`)に存在する`cache`ファイルのバックアップを取り出し、Discordの [#general-日本語](https://discord.com/channels/892807792996536453/1054390514583097414) フォーラムで質問してください。
...
<p className="font-serif text-center italic text-xl"> 翻訳: @massan7071 (on discord) & @hptuse </p>
